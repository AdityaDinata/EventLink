        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="login-container">
                    ...
                    <h2 style="color: white;" class="text-center mb-4">Login</h2>
                   <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="submit" name="login" class="btn btn-danger btn-block" value="Login" style="background-color: #F836CB;">
